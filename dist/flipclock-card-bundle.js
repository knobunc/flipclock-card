 ...
 */}const t="undefined"!=typeof window&&null!=window.customElements&&void 0!==window.customElements.polyfillWrapFlushCallback,i=(e,t,i=null)=>{for(;t!==i;){const i=t.nextSibling;e.removeChild(t),t=i}},n=`{{lit-${String(Math.random()).slice(2)}}}`,o=`\x3c!--${n}--\x3e`,s=new RegExp(`${n}|${o}`);class r{constructor(e,t){this.parts=[],this.element=t;const i=[],o=[],r=document.createTreeWalker(t.content,133,null,!1);let l=0,h=-1,f=0;const{strings:d,values:{length:p}}=e;for(;f<p;){const e=r.nextNode();if(null!==e){if(h++,1===e.nodeType){if(e.hasAttributes()){const t=e.attributes,{length:i}=t;let n=0;for(let e=0;e<i;e++)a(t[e].name,"$lit$")&&n++;for(;n-- >0;){const t=d[f],i=u.exec(t)[2],n=i.toLowerCase()+"$lit$",o=e.getAttribute(n);e.removeAttribute(n);const r=o.split(s);this.parts.push({type:"attribute",index:h,name:i,strings:r}),f+=r.length-1}}"TEMPLATE"===e.tagName&&(o.push(e),r.currentNode=e.content)}else if(3===e.nodeType){const t=e.data;if(t.indexOf(n)>=0){const n=e.parentNode,o=t.split(s),r=o.length-1;for(let t=0;t<r;t++){let i,s=o[t];if(""===s)i=c();else{const e=u.exec(s);null!==e&&a(e[2],"$lit$")&&(s=s.slice(0,e.index)+e[1]+e[2].slice(0,-"$lit$".length)+e[3]),i=document.createTextNode(s)}n.insertBefore(i,e),this.parts.push({type:"node",index:++h})}""===o[r]?(n.insertBefore(c(),e),i.push(e)):e.data=o[r],f+=r}}else if(8===e.nodeType)if(e.data===n){const t=e.parentNode;null!==e.previousSibling&&h!==l||(h++,t.insertBefore(c(),e)),l=h,this.parts.push({type:"node",index:h}),null===e.nextSibling?e.data="":(i.push(e),h--),f++}else{let t=-1;for(;-1!==(t=e.data.indexOf(n,t+1));)this.parts.push({type:"node",index:-1}),f++}}else r.currentNode=o.pop()}for(const e of i)e.parentNode.removeChild(e)}}const a=(e,t)=>{const i=e.length-t.length;return i>=0&&e.slice(i)===t},l=e=>-1!==e.index,c=()=>document.createComment(""),u=/([ \x09\x0a\x0c\x0d])([^\0-\x1F\x7F-\x9F "'>=/]+)([ \x09\x0a\x0c\x0d]*=[ \x09\x0a\x0c\x0d]*(?:[^ \x09\x0a\x0c\x0d"'`<>=]*|"[^"]*|'[^']*))$/;function h(e,t){const{element:{content:i},parts:n}=e,o=document.createTreeWalker(i,133,null,!1);let s=d(n),r=n[s],a=-1,l=0;const c=[];let u=null;for(;o.nextNode();){a++;const e=o.currentNode;for(e.previousSibling===u&&(u=null),t.has(e)&&(c.push(e),null===u&&(u=e)),null!==u&&l++;void 0!==r&&r.index===a;)r.index=null!==u?-1:r.index-l,s=d(n,s),r=n[s]}c.forEach(e=>e.parentNode.removeChild(e))}const f=e=>{let t=11===e.nodeType?0:1;const i=document.createTreeWalker(e,133,null,!1);for(;i.nextNode();)t++;return t},d=(e,t=-1)=>{for(let i=t+1;i<e.length;i++){const t=e[i];if(l(t))return i}return-1};
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */const k=` ${n} `;class _{constructor(e,t,i,n){this.strings=e,this.values=t,this.type=i,this.processor=n}getHTML(){const e=this.strings.length-1;let t="",i=!1;for(let s=0;s<e;s++){const e=this.strings[s],r=e.lastIndexOf("\x3c!--");i=(r>-1||i)&&-1===e.indexOf("--\x3e",r+1);const a=u.exec(e);t+=null===a?e+(i?k:o):e.substr(0,a.index)+a[1]+a[2]+"$lit$"+a[3]+n}return t+=this.strings[e],t}getTemplateElement(){const e=document.createElement("template");return e.innerHTML=this.getHTML(),e}}
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
...
`;console.info("%c  FLIPCLOCK-CARD \n%c  Version 0.0.1  ","color: orange; font-weight: bold; background: black","color: white; font-weight: bold; background: dimgray");let ee=class extends X{constructor(){super(...arguments),this._clockFaces=["TwentyFourHourClock","TwelveHourClock"],this._firstUpdated=!1}set hass(e){this._hass=e,this._date=new Date,setInterval(this.updateTimezones.bind(this),500)}setConfig(e){if(!e)throw new Error("Invalid configuration");this._config=function e(...t){const i=e=>e&&"object"==typeof e;return t.reduce((t,n)=>(Object.keys(n).forEach(o=>{const s=t[o],r=n[o];Array.isArray(s)&&Array.isArray(r)?t[o]=s.concat(...r):i(s)&&i(r)?t[o]=e(s,r):t[o]=r}),t),{})}({title:null,time:{face:"TwentyFourHourClock",showSeconds:!1,showMeridium:!0},timezones:[],date:{format:{weekday:"long",day:"numeric",month:"long",year:"numeric"},hidden:!1,locale:null}},e),this._timezones=[],this._config.timezones.forEach(e=>{this._timezones.push({id:"string"==typeof e?e:e.id,title:"string"==typeof e?e:e.title})})}shouldUpdate(){return!this._firstUpdated}firstUpdated(){this._firstUpdated=!0}render(){return this._config&&this._hass?V`
      ...
      ${Q}
    `:V``}getCardSize(){return 3}showValue(e){return null!=e}renderClock(){if(this._clockFaces.includes(this._config.time.face)){const e=document.createElement("div");return e.className="fc-now",new K(e,this._date,{face:this._config.time.face,showSeconds:this._config.time.showSeconds,showMeridium:this._config.time.showMeridium}),V`${e}`}return V``}renderDate(){return this._config.date.hidden?V``:V` <div class="fc-date">
        ${this.formatDate(this._date)}
      </div>`}formatDate(e,t){var i;const n=this._config.date.locale||(null===(i=this._hass)||void 0===i?void 0:i.language),o=t||this._config.date.format;return e.toLocaleDateString(n,o)}formatTimezone(e){return this.formatDate(this._date,{hour:"numeric",minute:"numeric",timeZone:e,weekday:"short"})}renderTimezones(){return this._timezones.length?V`
    ...
    `:V``}updateTimezones(){this._timezones.map((e,t)=>{var i;const n=null===(i=this.shadowRoot)||void 0===i?void 0:i.getElementById("tz_"+t);n&&(n.innerHTML=this.formatTimezone(e.id))})}};var te;e([J()],ee.prototype,"_hass",void 0),e([J()],ee.prototype,"_config",void 0),ee=e([(te="flipclock-card",e=>"function"==typeof e?((e,t)=>(window.customElements.define(e,t),t))(te,e):((e,t)=>{const{kind:i,elements:n}=t;return{kind:i,elements:n,finisher(t){window.customElements.define(e,t)}}})(te,e))],ee);export{ee as FlipClockCard};
